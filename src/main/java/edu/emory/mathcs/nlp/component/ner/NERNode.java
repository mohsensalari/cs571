...
//	============================== POS TAG ==============================
	...
	public boolean isExactMatch(NERNode target){//same NamedEntityTag + same WordFrom
		if(!this.isNamedEntityTag(target.getNamedEntityTag()))
			return false;
		else if (!this.getWordForm().equals(target.getWordForm()))
				return false;
